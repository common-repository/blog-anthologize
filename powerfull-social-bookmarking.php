<?php
/*
Plugin Name: Best Social Bookmarking
Version: 1.02
Plugin URI: http://www.blogform.co.cc/wordpress-plugins/powerfull-social-bookmarking-wordpress-plugin/
Description: POWERFULL SOCIAL BOOKMARKING plugin will add a image below your posts, allowing your visitors to share your posts with their friends, on FaceBook, Twitter, Myspace, Friendfeed, Technorati, del.icio.us, Digg, Google, Yahoo Buzz, StumbleUpon, 
Author: Blogform
...
function WP_Social_Bookmarking($content) {
    ...
    global $post;
	$images = plugins_url().'/blog-anthologize/images/';
...
. '<a href="http://www.blogform.co.cc" target="_blank" title="HOW TO MAKE MONEY ONLINE"><img src="' . $images . 'blogform.png" style="width:30px;height:30px;border:0px;" alt="HOW TO MAKE MONEY ONLINE" title="HOW TO MAKE MONEY ONLINE" /></a>' . "\n"			 
